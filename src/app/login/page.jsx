  ...
  return (
    <div className="w-[45%] items-start flex h-full justify-center flex-col">
      <div className="w-[80%] flex flex-col h-[90%] gap-4">
        ...
        <button onClick={handleWalletConnect} className="flex flex-row gap-3 py-2 font-bold justify-center items-center w-full rounded-[32px] bg-transparent border border-black">
        <Image src={orange} alt="orange" className="w-8" />  {  publicKey ?publicKey.toBase58() : 
          <>
